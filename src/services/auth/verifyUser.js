...
module.exports = class VerifyUserService extends AuthService
{
    ...
    async lookupUser() {
      // TODO calculate token expiry      
      this.user = await User.fetchOne({verification_token: this.token})      
      return this
    }
    ...
    async sendWelcomeMail() {
      ...
      await mailSvc.buildBody('welcome', {user: this.user, url: this.user.generateVerificationUrl() })
      await mailSvc.send()    
      return this
    }
}
